        ...
        <div class="form-container">
          <div class="login-form-top">
            <form action="add" method="post" enctype="multipart/form-data">
              ...
              <div class="form-input-title"> USERNAME <span class="required">*</span> <span class="form-invalid">
              ...
              <div class="form-input-title"> EMAIL<span class="required">*</span> <span class="form-invalid">
              ...
              <div class="form-input-title"> CONFIRM PASSWORD<span class="required">*</span><span class="form-invalid">
         ...
         <p class="text-info"> Add user with admin priviledges</p>
          </div>
