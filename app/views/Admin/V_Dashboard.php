  ...
  <div class="main--content">
    ...
    <div class="dashDetails">
      <div class="dash-main">
        ...
        <!-- <div class="dashUnit">
          <span>Donations <strong> 13</strong></span>
          <div class="dash_table">
            <table>
              <tbody>
            ...
            <div class="viewall">
              <button>
                <a href="<?php echo URLROOT?>/Admin/donations">View All</a>
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="dashUnit">
          <span>Contribution <strong> 13</strong></span>
          <div class="dash_table">
            <table>
              <tbody>
            ...
            <div class="viewall">
              <button>
                <a href="<?php echo URLROOT?>/Admin/contributions">View All</a>
              </button>
            </div>
          </div>
        </div> -->
