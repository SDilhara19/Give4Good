...
>>>>>>> 507039d45abbbefb9d3eaae99553f41235372f2d
                  ...
                  <i class="fa-solid fa-info"></i>
                    ...
                    <?php if($super_individual->status== 'Active'){ ?>
...
<?php } ?>
<?php if($super_individual->status== 'Deactive'){ ?>
  ...
  <a class="action-icons">
                    <i class= "fa-solid fa-check" onclick = 'if(window.confirm("Are you sure you want to activate the <?php echo $super_individual->user_id ?>")){
                      window.open("<?php echo URLROOT ?>/Admin_Individual/setReactive/<?php echo $super_individual->user_id ?>");
                    }'>
                    </i>
                    </a>
<?php } ?>
...
<?php if($super_individual->status== 'Pending'){ ?>
