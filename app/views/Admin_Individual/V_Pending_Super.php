              ...
              <tbody>
                ...
                foreach ($data as $super_individual) {
                  ...
                  <i class="fa-solid fa-info"></i>
                    ...
                    <i class= "fa-solid fa-lock" onclick = 'if(window.confirm("Are you sure you want to activate the <?php echo $super_individual->user_id ?>")){
                    ...
                    <a href="" class="action-icons">
                    <i class= "fa-solid fa-check" onclick = 'if(window.comfirm("Are you sure you want to deactivate the <?php echo $super_individual->user_id ?>")){
