<div class="side-bar-main active">
    ...
    <ul class="nav-links">
      ...
      <li><a href="<?php echo URLROOT?>/Admin/add"><i class="fa-solid fa-user-plus"></i><p>Add an admin</p></a></li>
      <li><a href="<?php echo URLROOT?>/Admin/category"><i class="fa-solid fa-file-invoice"></i><p>Add documents</p></a></li>
