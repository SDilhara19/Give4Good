<div class="side-bar-main active">
    ...
    <ul class="nav-links">
      <li><a href="<?php echo URLROOT?>/Profile/orgProfile"><i class="fa-brands fa-windows"></i><p>Personal Info</p></a></li>
      <li><a href="<?php echo URLROOT?>/Profile/edit_org"><i class="fa-regular fa-pen-to-square"></i><p>Edit profile</p></a></li>
      <li><a href="<?php echo URLROOT?>/Profile/donations"><i class="fa-light fa-handshake-angle"></i><p>Donations</p></a></li>
      <li><a href="<?php echo URLROOT?>/Profile/fundraisers"><i class="fa-light fa-hand-holding-dollar"></i><p>Fundraisers</p></a></li>
